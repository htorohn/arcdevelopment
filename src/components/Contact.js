...
const Contact = (props) => {
    ...
    const onConfirm = () => {
        setIsLoading(true)
        axios
            .get('https://us-central1-arcdevelopment-837fc.cloudfunctions.net/sendMail', {
                params: {
                    name,
                    email,
                    phone,
    ...
    return (
        <Grid container direction='row'>
            ...
            <Grid item container direction='column' justify='center'
                alignItems='center' lg={4} xl={3} style={{ marginBottom: matchesMD ? '5em' : 0, marginTop: matchesSM ? '1em' : matchesMD ? '5em' : 0 }}>
                <Grid item >
                    <Grid item>
                    ...
                    <Grid item container style={{ marginBottom: '2em' }}>
                        ...
                        <Grid item>
                            <Typography variant='body1' style={{ color: theme.palette.common.blue, fontSize: '1rem' }} >
                                <a href="mailto:htorohn@gmail.com" style={{ textDecoration: 'none', color: 'inherit' }}>htorohn@gmail.com</a>
                            </Typography>
                        </Grid>
                    </Grid>
